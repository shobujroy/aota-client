                  ...
                  <div className={`col-md-12 col-sm-12 ${styles.MeetMemberCarousel}`}>
                    ...
                    <Carousel
                      ...
                      <div className={styles.SlideIcon}>
                        ...
                        <Button prevLabel={directionButtons()} > <Image width={48} height={48} src={"/images/Group 4.png"} /> </Button>

                        <Button nextLabel={directionButtons()} > <Image width={48} height={48} src={"/images/Group 3.png"} /> </Button>
                      ...
                      <Carousel.Item>
                        ...
                        <div className={styles.MeetMemberCarouselItam}>
                          ...
                          <div className={styles.CarouselItam}>
                            ...
                            <Image width={180} height={200} src={"/images/image 14.png"} />
                            <h3>Jacob Jones</h3>
                            <p>Illustrator</p>
                          ...
                          <div className={styles.CarouselItam}>
                            <Image width={180} height={200} src={"/images/image 15.png"} />
                          ...
                          <div className={styles.CarouselItam}>
                            <Image width={180} height={200} src={"/images/image 16.png"} />
